...
function launchDemo() {
  ...
  event(g,'info',tr('Bruno me dit avoir reçu 1. À vérifier : ses voisins et la nuit concernée.','Bruno says he received 1. Check his neighbours and which night.'),[ps[0].id,ps[2].id],ps[1].id,'1');
